...
proc vck190_create {} {
	...
	platform create -name vck190_wrapper -hw ../Software/Vitis/vck190_wrapper.xsa
	
	domain create -name psv_pmc_0 -os standalone -proc psv_pmc_0
#	bsp config stdin none
#	bsp config stdout none
	bsp regenerate
	
	domain create -name psv_psm_0 -os standalone -proc psv_psm_0
#	bsp config stdin none
#	bsp config stdout none
	bsp regenerate
